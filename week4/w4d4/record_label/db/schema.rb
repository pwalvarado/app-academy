...
ActiveRecord::Schema.define(version: 20141031005513) do
  ...
  add_index "albums", ["ttype"], name: "index_albums_on_ttype", using: :btree
  ...
  add_index "notes", ["user_id", "track_id", "body"], name: "index_notes_on_user_id_and_track_id_and_body", unique: true, using: :btree
  ...
  add_index "tracks", ["ttype"], name: "index_tracks_on_ttype", using: :btree
